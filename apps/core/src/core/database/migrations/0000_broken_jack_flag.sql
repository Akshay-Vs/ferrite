...
CREATE INDEX "idx_phones_lookup" ON "user_phones" USING btree ("country_code","phone");--> statement-breakpoint
CREATE INDEX "idx_phones_default" ON "user_phones" USING btree ("user_id") WHERE is_default = true;--> statement-breakpoint
...
CREATE INDEX "idx_sessions_ip_address" ON "user_sessions" USING btree ("ip_address");--> statement-breakpoint
...
CREATE INDEX "idx_staff_owner" ON "staff_members" USING btree ("is_owner") WHERE is_owner = true;--> statement-breakpoint
...
CREATE INDEX "idx_payment_methods_default" ON "user_payment_methods" USING btree ("user_id") WHERE is_default = true;--> statement-breakpoint
CREATE INDEX "idx_payment_methods_expires_at" ON "user_payment_methods" USING btree ("expires_at");