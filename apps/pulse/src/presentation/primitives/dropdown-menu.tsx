		...
		<MenuPrimitive.Portal>
			...
			>
				<MenuPrimitive.Popup
					...
					className={cn(
						'relative isolate z-50 max-h-(--available-height) w-(--anchor-width) min-w-48 origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-[2rem] border gradient-border/60 bg-surface/80 p-2 mt-2 text-popover-foreground shadow-2xl shadow-accent/5 backdrop-blur-2xl duration-100 outline-none',
...
function DropdownMenuItem({
	...
	return (
		<MenuPrimitive.Item
			...
			className={cn(
				'group/dropdown-menu-item relative flex h-13 cursor-pointer items-center gap-2.5 rounded-full border border-transparent px-6 text-sm font-medium outline-none select-none transition-colors',
